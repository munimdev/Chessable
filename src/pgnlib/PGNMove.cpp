...
std::string pgn::Move::getPGN()
{
  std::stringstream moveStream;
  if (this->hdata->complete)
		moveStream << this->hdata->number << ". " << this->hdata->white << " " << this->hdata->black;
	else if (this->hdata->white.valid())
		moveStream << this->hdata->number << ". " << this->hdata->white;
	else if (this->hdata->black.valid())
		moveStream << this->hdata->number << "... " << this->hdata->black;
